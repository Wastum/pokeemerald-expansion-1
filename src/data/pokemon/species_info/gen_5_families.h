...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_VICTINI] =
    {
        ...
        .abilities = { ABILITY_VICTORY_STAR, ABILITY_NONE, ABILITY_PRANKSTER },
    ...
    [SPECIES_SNIVY] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_MOXIE, ABILITY_CONTRARY },
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_PSYCHOPATH, ABILITY_FUR_COAT },
    ...
    [SPECIES_EMOLGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_PRANKSTER, ABILITY_MOTOR_DRIVE },
        .bodyColor = BODY_COLOR_WHITE,
