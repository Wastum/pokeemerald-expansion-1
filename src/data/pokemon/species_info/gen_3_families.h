...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_MUDKIP] =
    {
        ...
        .abilities = { ABILITY_TORRENT, ABILITY_DAMP, ABILITY_WATER_ABSORB },
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SIMPLE, ABILITY_GLUTTONY, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Zigzagoon"),
        .cryId = CRY_ZIGZAGOON,
        .natDexNum = NATIONAL_DEX_ZIGZAGOON,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #endif
        .abilities = { ABILITY_LEVITATE, ABILITY_COMPOUND_EYES, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_GREEN,
