...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_LEAF_GUARD, ABILITY_PIXILATE },
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_STRONG_JAW, ABILITY_SHEER_FORCE },
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_WATER_ABSORB, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_LANTURN}),
    },
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        //.evolutions = EVOLUTION({EVO_ITEM, ITEM_SHINY_STONE, SPECIES_TOGETIC}),
    },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 90 : 75)
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_SPEED_BOOST, ABILITY_PIXILATE },
    #else
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_INFILTRATOR },
    #endif
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_JUMPLUFF}),
    },
    ...
    [SPECIES_YANMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_SPEED_BOOST, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Yanma"),
        .cryId = CRY_YANMA,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY, ABILITY_EARTH_EATER },
        .bodyColor = BODY_COLOR_RED,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SNOW_WARNING, ABILITY_NO_GUARD, ABILITY_DELTA_STREAM },
        .bodyColor = BODY_COLOR_RED,
