...
static u32 LoopedTask_CannotAccessPC(s32); // Pokenav PC Can't access
...
static void PrintCannotAccessPC(void); // Pokenav PC can't access print
...
static const u8 *const sPageDescriptions[] =
{
    ...
    [POKENAV_MENUITEM_CONDITION_ACCESS_PC]     = gText_Pokenav_Access_PC, // Pokenav PC
...
// Pokenav PC Looped Task if no pc access
...
// Pokenav PC, print the cannot access pc text
