...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_CUSTOM_DEXNAV_SEARCHING // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_CUSTOM_DEXNAV // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_CUSTOM_DETECTOR // Allow player to find hidden mons
