...
#define FLAG_CUSTOM_DYNAMAX_BATTLE    0x20 // Dynamax battles enabled
#define FLAG_CUSTOM_EXP_SHARE    0x21 // EXP Share
#define FLAG_CUSTOM_VS_SEEKER    0x22 // VS Seeker
#define FLAG_CUSTOM_DEXNAV    0x23 // DexNAV
#define FLAG_CUSTOM_DETECTOR    0x24 // Unused Flag
#define FLAG_CUSTOM_DEXNAV_SEARCHING    0x25 // Unused Flag
#define FLAG_CUSTOM_DEXNAV_SPECIES    0x26 // Unused Flag
